...
- [01 - Program Overview & Features](runbook/01-PROGRAM-OVERVIEW.md)
  - System description
  - Normal HMS features
...
- [02 - CVE Mapping](runbook/02-CVE-MAPPING.md)
...
- [03 - Cloudflare Setup Guide](runbook/03-CLOUDFLARE-SETUP.md)
...
- [04 - Complete Exploitation Walkthrough](runbook/04-COMPLETE-EXPLOITATION-WALKTHROUGH.md)
...
- [05 - MITM Attacks Guide](runbook/05-MITM-ATTACKS-GUIDE.md)
...
- [06 - SQL Injection Exploitation](runbook/06-EXPLOITATION-SQLI.md)
- [07 - Cross-Site Scripting (XSS)](runbook/07-EXPLOITATION-XSS.md)
- [08 - Insecure Direct Object Reference (IDOR)](runbook/08-EXPLOITATION-IDOR.md)
- [09 - Open Redirect](runbook/09-EXPLOITATION-OPEN-REDIRECT.md)

#### **Intermediate Vulnerabilities (Medium Difficulty)**
- [10 - Mass Assignment](runbook/10-EXPLOITATION-MASS-ASSIGNMENT.md)
- [11 - Directory Traversal / LFI](runbook/11-EXPLOITATION-DIRECTORY-TRAVERSAL.md)
- [12 - Business Logic Flaws](runbook/12-EXPLOITATION-BUSINESS-LOGIC.md)
- [13 - API Security Issues](runbook/13-EXPLOITATION-API.md)

#### **Advanced Vulnerabilities (Hard Difficulty)**
- [14 - Command Injection](runbook/14-EXPLOITATION-COMMAND-INJECTION.md)
- [15 - File Upload RCE](runbook/15-EXPLOITATION-FILE-UPLOAD.md)
- [16 - Server-Side Request Forgery (SSRF)](runbook/16-EXPLOITATION-SSRF.md)
- [17 - Race Conditions](runbook/17-EXPLOITATION-RACE-CONDITIONS.md)

#### **Expert Vulnerabilities (Impossible Difficulty)**
- [18 - Server-Side Template Injection (SSTI)](runbook/18-EXPLOITATION-SSTI.md)
- [19 - Insecure Deserialization](runbook/19-EXPLOITATION-DESERIALIZATION.md)
- [20 - JWT Advanced Attacks](runbook/20-EXPLOITATION-JWT.md)
- [21 - XML External Entity (XXE)](runbook/21-EXPLOITATION-XXE.md)

### **Part 7: Tools & Techniques**
- [22 - Penetration Testing Tools](runbook/22-TOOLS-REFERENCE.md)
  - Burp Suite
  - SQLMap
  - OWASP ZAP
  - Custom scripts
...
- [23 - WAF Bypass Techniques](runbook/23-WAF-BYPASS-TECHNIQUES.md)
  - WAF bypass methods
  - Filter evasion
  - Encoding techniques
  - Obfuscation methods
...
- [24 - CTF Guide & Flags](runbook/24-CTF-GUIDE.md)
  - All 20 flags
  - Capture methods
  - Scoring system
  - Leaderboard
...
### **Part 9: Remediation**
- [25 - Security Fixes & Best Practices](runbook/25-REMEDIATION-GUIDE.md)
...
### **For Beginners:**
- Start here → [runbook/01-PROGRAM-OVERVIEW.md](runbook/01-PROGRAM-OVERVIEW.md)
- Then → [runbook/04-COMPLETE-EXPLOITATION-WALKTHROUGH.md](runbook/04-COMPLETE-EXPLOITATION-WALKTHROUGH.md)
- Learn MITM → [runbook/05-MITM-ATTACKS-GUIDE.md](runbook/05-MITM-ATTACKS-GUIDE.md)
- Practice → Start with SQL Injection (covered in guide 04)

### **For Intermediate:**
- Review → [runbook/02-CVE-MAPPING.md](runbook/02-CVE-MAPPING.md)
- Master MITM → [runbook/05-MITM-ATTACKS-GUIDE.md](runbook/05-MITM-ATTACKS-GUIDE.md)
- Practice → Medium difficulty exploits (guides 10-13)
- Tools → [runbook/22-TOOLS-REFERENCE.md](runbook/22-TOOLS-REFERENCE.md)

### **For Advanced:**
- Master → Hard difficulty guides (14-17)
- Expert → Impossible difficulty guides (18-21)
- Bypasses → [runbook/23-WAF-BYPASS-TECHNIQUES.md](runbook/23-WAF-BYPASS-TECHNIQUES.md)
...
### **Week 1: Foundations**
```
Day 1-2: Read runbook/01-PROGRAM-OVERVIEW.md
Day 3-4: Read runbook/02-CVE-MAPPING.md
Day 5-7: Practice runbook/04-COMPLETE-EXPLOITATION-WALKTHROUGH.md (Low difficulty)
```
...
```
Week 3: Medium difficulty exploits (guides 10-13)
Week 4: Tool mastery (runbook/05-MITM-ATTACKS-GUIDE.md)
```

### **Week 5-6: Advanced**
```
Week 5: Hard difficulty guides (14-17)
Week 6: WAF bypass techniques (runbook/23-WAF-BYPASS-TECHNIQUES.md)
```

### **Week 7-8: Expert**
```
Week 7: Impossible difficulty guides (18-21)
...
- License: `LICENSE`
- Complete Runbook: `runbook/INDEX.md`
...
Start with: [runbook/01 - Program Overview & Features →](runbook/01-PROGRAM-OVERVIEW.md)
